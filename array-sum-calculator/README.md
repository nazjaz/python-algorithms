...
A Python implementation of array sum calculation using both iterative and recursive approaches with comprehensive performance comparison. This tool helps understand the differences between iterative and recursive implementations and their performance characteristics.

## Project Title and Description

The Array Sum Calculator tool implements sum calculation using three different approaches: iterative, recursive, and recursive with index parameter. It provides detailed performance comparison, timing analysis, and comprehensive reports to help understand the trade-offs between different implementation strategies.

This tool solves the problem of understanding sum calculation implementations by providing side-by-side performance comparison and detailed analysis of different algorithmic approaches.

**Target Audience**: Students learning algorithms, developers studying recursion vs iteration, educators teaching computer science concepts, and anyone interested in understanding array sum calculation and performance analysis.

## Features

- Iterative sum calculation
- Recursive sum calculation (two variants)
...
```bash
cd /path/to/python-algorithms/array-sum-calculator
```
...
```bash
python src/main.py 1 2 3 4 5 --method iterative
python src/main.py 1 2 3 4 5 --method recursive
python src/main.py 1 2 3 4 5 --method recursive_indexed
```
...
```bash
python src/main.py 1 2 3 4 5 --iterations 1000
```
...
```bash
python src/main.py 1 2 3 4 5 --report report.txt
```

### Command-Line Arguments

- `numbers`: (Required) One or more numbers to sum
- `-c, --config`: Path to configuration file (default: config.yaml)
- `-m, --method`: Calculation method - iterative, recursive, recursive_indexed, or compare (default: compare)
...
**Compare Methods:**
1. Run: `python src/main.py 1 2 3 4 5`
2. Review timing for each method
3. Identify fastest method

**Study Algorithms:**
1. Use specific method: `python src/main.py 1 2 3 --method recursive`
2. Review logs to see algorithm execution
3. Understand different approaches

**Performance Analysis:**
1. Test with different array sizes
2. Use multiple iterations: `python src/main.py 1 2 3 4 5 --iterations 1000`
...
- `src/main.py`: Contains the `ArraySumCalculator` class and main logic
...
**Iterative Approach:**
- Uses a loop to accumulate sum
- Time Complexity: O(n)
- Space Complexity: O(1)
- No recursion overhead
- Generally fastest for large arrays
...
- May hit recursion limits for large arrays

**Recursive Indexed Approach:**
- Recursive with index parameter instead of slicing
- Time Complexity: O(n)
- Space Complexity: O(n) due to call stack
- More memory efficient than slicing variant
- Still subject to recursion limits
...
- Sum calculation with various inputs
